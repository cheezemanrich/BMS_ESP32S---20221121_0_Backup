...
if (!!window.EventSource) {
  ...
  source.addEventListener('new_readings', function(e) {
	...
	if(Number(obj.batt2data11 == 0) && Number(obj.batt2data12 == 0)) {document.getElementById("systemcolor").innerHTML = "<h3 style=\"background-color:MediumSeaGreen;\"><b>Battery 2</b></h3>"} else {document.getElementById("systemcolor").innerHTML = "<h3 style=\"background-color:Tomato;\"><b>Battery 2</b></h3>"};
	document.getElementById("batt2data1").innerHTML = (Number(obj.batt2data1) /1000).toFixed(3);
    document.getElementById("batt2data2").innerHTML = (Number(obj.batt2data2) /1000).toFixed(3);
    document.getElementById("batt2data3").innerHTML = (Number(obj.batt2data3) /1000).toFixed(3);
	document.getElementById("batt2data4").innerHTML = (Number(obj.batt2data4) /1000).toFixed(3);
	document.getElementById("batt2data5").innerHTML = (Number(obj.batt2data5) /1000).toFixed(3);
	document.getElementById("batt2data6").innerHTML = (Number(obj.batt2data6) /100).toFixed(1);
    document.getElementById("batt2data7").innerHTML = (Number(obj.batt2data7) /100).toFixed(1);
    document.getElementById("batt2data8").innerHTML = (Number(obj.batt2data8) /100).toFixed(1);
	document.getElementById("batt2data9").innerHTML = (Number(obj.batt2data9) /100).toFixed(1);
	document.getElementById("batt2data10").innerHTML = (Number(obj.batt2data10) /100).toFixed(1);
	if(Number(obj.batt2data11 == 0)){document.getElementById("batt2data11").innerHTML = "OK"} else {document.getElementById("batt2data11").innerHTML = "WARNING"};
	if(Number(obj.batt2data12 == 0)){document.getElementById("batt2data12").innerHTML = "OK"} else {document.getElementById("batt2data12").innerHTML = "WARNING"};
	document.getElementById("batt2data13").innerHTML = (Number(obj.batt2data13) /100).toFixed(1);
	if(obj.batt2data14 == 1){document.getElementById("batt2data14").innerHTML = "BALANCE"} else {document.getElementById("batt2data14").innerHTML = "OFF"};
