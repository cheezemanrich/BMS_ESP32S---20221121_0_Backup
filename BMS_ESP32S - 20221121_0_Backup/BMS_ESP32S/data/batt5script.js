...
if (!!window.EventSource) {
  ...
  source.addEventListener('new_readings', function(e) {
	...
	if(Number(obj.batt5data11 == 0) && Number(obj.batt5data12 == 0)) {document.getElementById("systemcolor").innerHTML = "<h3 style=\"background-color:MediumSeaGreen;\"><b>Battery 5</b></h3>"} else {document.getElementById("systemcolor").innerHTML = "<h3 style=\"background-color:Tomato;\"><b>Battery 5</b></h3>"};
	document.getElementById("batt5data1").innerHTML = (Number(obj.batt5data1) /1000).toFixed(3);
    document.getElementById("batt5data2").innerHTML = (Number(obj.batt5data2) /1000).toFixed(3);
    document.getElementById("batt5data3").innerHTML = (Number(obj.batt5data3) /1000).toFixed(3);
	document.getElementById("batt5data4").innerHTML = (Number(obj.batt5data4) /1000).toFixed(3);
	document.getElementById("batt5data5").innerHTML = (Number(obj.batt5data5) /1000).toFixed(3);
	document.getElementById("batt5data6").innerHTML = (Number(obj.batt5data6) /100).toFixed(1);
    document.getElementById("batt5data7").innerHTML = (Number(obj.batt5data7) /100).toFixed(1);
    document.getElementById("batt5data8").innerHTML = (Number(obj.batt5data8) /100).toFixed(1);
	document.getElementById("batt5data9").innerHTML = (Number(obj.batt5data9) /100).toFixed(1);
	document.getElementById("batt5data10").innerHTML = (Number(obj.batt5data10) /100).toFixed(1);
	if(Number(obj.batt5data11 == 0)){document.getElementById("batt5data11").innerHTML = "OK"} else {document.getElementById("batt5data11").innerHTML = "WARNING"};
	if(Number(obj.batt5data12 == 0)){document.getElementById("batt5data12").innerHTML = "OK"} else {document.getElementById("batt5data12").innerHTML = "WARNING"};
	document.getElementById("batt5data13").innerHTML = (Number(obj.batt5data13) /100).toFixed(1);
	if(obj.batt5data14 == 1){document.getElementById("batt5data14").innerHTML = "BALANCE"} else {document.getElementById("batt5data14").innerHTML = "OFF"};
	document.getElementById("batt4data15").innerHTML = Number(obj.batt5data15) /10;
