...
if (!!window.EventSource) {
  ...
  source.addEventListener('new_readings', function(e) {
	...
	if(Number(obj.batt7data11 == 0) && Number(obj.batt7data12 == 0)) {document.getElementById("systemcolor").innerHTML = "<h3 style=\"background-color:MediumSeaGreen;\"><b>Battery 7</b></h3>"} else {document.getElementById("systemcolor").innerHTML = "<h3 style=\"background-color:Tomato;\"><b>Battery 7</b></h3>"};
	document.getElementById("batt7data1").innerHTML = (Number(obj.batt7data1) /1000).toFixed(3);
    document.getElementById("batt7data2").innerHTML = (Number(obj.batt7data2) /1000).toFixed(3);
    document.getElementById("batt7data3").innerHTML = (Number(obj.batt7data3) /1000).toFixed(3);
	document.getElementById("batt7data4").innerHTML = (Number(obj.batt7data4) /1000).toFixed(3);
	document.getElementById("batt7data5").innerHTML = (Number(obj.batt7data5) /1000).toFixed(3);
	document.getElementById("batt7data6").innerHTML = (Number(obj.batt7data6) /100).toFixed(1);
    document.getElementById("batt7data7").innerHTML = (Number(obj.batt7data7) /100).toFixed(1);
    document.getElementById("batt7data8").innerHTML = (Number(obj.batt7data8) /100).toFixed(1);
	document.getElementById("batt7data9").innerHTML = (Number(obj.batt7data9) /100).toFixed(1);
	document.getElementById("batt7data10").innerHTML = (Number(obj.batt7data10) /100).toFixed(1);
	if(Number(obj.batt7data11 == 0)){document.getElementById("batt7data11").innerHTML = "OK"} else {document.getElementById("batt7data11").innerHTML = "WARNING"};
	if(Number(obj.batt7data12 == 0)){document.getElementById("batt7data12").innerHTML = "OK"} else {document.getElementById("batt7data12").innerHTML = "WARNING"};
	document.getElementById("batt7data13").innerHTML = (Number(obj.batt7data13) /100).toFixed(1);
	if(obj.batt7data14 == 1){document.getElementById("batt7data14").innerHTML = "BALANCE"} else {document.getElementById("batt7data14").innerHTML = "OFF"};
